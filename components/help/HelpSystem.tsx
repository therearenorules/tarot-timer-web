...
const HelpSystem: React.FC<HelpSystemProps> = ({
  ...
  const helpData: HelpItem[] = [
    // 일반 사용법
    {
      ...
      answer: '홈 화면의 "카드 뽑기" 버튼을 눌러주세요. 현재 시간대에 맞는 카드가 랜덤으로 선택됩니다. 하루에 여러 번 뽑을 수 있으며, 각 시간대마다 다른 에너지를 느껴보세요.',
    ...
    // 기능 설명
    {
      ...
      answer: '3장의 카드를 뽑아 과거-현재-미래를 확인하는 기능입니다. 스프레드 탭에서 이용할 수 있으며, 현재 상황에 대한 더 깊은 통찰을 얻을 수 있습니다.',
